  ...
  return (
    <main className="relative min-h-[calc(100vh-80px)] overflow-hidden bg-gray-50 flex flex-col justify-center">
      ...
      <div className="absolute left-0 top-0 -z-10 h-full w-full bg-white">
        <div className="absolute top-0 right-0 -mr-20 -mt-20 h-[500px] w-[500px] rounded-full bg-indigo-50 blur-3xl opacity-60"></div>
        <div className="absolute bottom-0 left-0 -ml-20 -mb-20 h-[500px] w-[500px] rounded-full bg-violet-50 blur-3xl opacity-60"></div>
      </div>
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="max-w-xl mx-auto mt-10">
          <div className="p-2 bg-white rounded-2xl shadow-xl shadow-indigo-100/50 border border-gray-200 flex flex-col sm:flex-row gap-2">
            <input
              type="text"
              value={quickQuestion}
        ...
        <div className="mt-16 relative">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-white/20 p-6 rounded-2xl shadow-2xl max-w-sm mx-auto transform rotate-[-2deg] hover:rotate-0 transition-transform duration-500">
            ...
            <div className="space-y-2">
              <div className="w-full bg-indigo-50 p-3 rounded-lg border border-indigo-100 flex justify-between items-center">
                <span className="text-sm font-medium text-indigo-900">Minimalist</span>
                <span className="text-sm font-bold text-indigo-600">64%</span>
              </div>
